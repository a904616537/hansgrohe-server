...
const config = {
	...
	development: {
		...
		wechat : {
			...
			token          : 'KainTest',
			encodingAESKey : '',
			url            : 'http://2d592c45.ngrok.io',
			oauth          : '/wechat/oauth/login',
			local          : '106.14.94.210:8110',
			pay : {
	...
	test: {
		...
		wechat : {
			...
			token          : 'KainTest',
			encodingAESKey : '',
			url            : 'http://kain.ngrok.cc',
			oauth          : '/wechat/oauth/login',
			local : 'testwechat.eatisco.com',
			pay : {
				partnerKey : "<partnerkey>",
				appId      : "<appid>",
				mchId      : "<mchid>",
	...
	production : {
		...
		wechat : {
			...
			url            : 'http://server.eatisco.com',
			oauth          : '/wechat/oauth/login',
			local          : 'wechat.eatisco.com',
			pay : {
