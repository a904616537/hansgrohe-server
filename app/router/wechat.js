...
.get((req, res) => {
	const menu = {
		"button" :[{
			"type" : "view",
			"name" : "Hansgrohe Shop",
			"url"  : "https://open.weixin.qq.com/connect/oauth2/authorize?appid="+setting.appid+"&redirect_uri=http%3A%2F%2F"+setting.local+"&response_type=code&scope=snsapi_userinfo&state=123#wechat_redirect"
		},{
			"type" : "view",
			"name" : "Registered",
			"url"  : "https://open.weixin.qq.com/connect/oauth2/authorize?appid="+setting.appid+"&redirect_uri=http%3A%2F%2F"+setting.local+"&response_type=code&scope=snsapi_userinfo&state=123#wechat_redirect"
